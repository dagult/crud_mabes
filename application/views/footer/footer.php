<script src="<?php echo base_url().'assets/dashboard/js/vendor/jquery-1.12.4.min.js'?>"></script>
    ...
    <!-- jvectormap JS
		============================================ -->
    <script src="<?php echo base_url().'assets/dashboard/js/jvectormap/jquery-jvectormap-2.0.2.min.js'?>"></script>
    <script src="<?php echo base_url().'assets/dashboard/js/jvectormap/jquery-jvectormap-world-mill-en.js'?>"></script>
    <script src="<?php echo base_url().'assets/dashboard/js/jvectormap/jvectormap-active.js'?>"></script>
    <!-- sparkline JS
		============================================ -->
	...
	<!--  Chat JS
		============================================ -->
    <script src="<?php echo base_url().'assets/dashboard/js/chat/moment.min.js'?>"></script>
	...
	<!-- tawk chat JS
		============================================ -->
    <script src="<?php echo base_url().'assets/dashboard/js/tawk-chat.js'?>"></script>
